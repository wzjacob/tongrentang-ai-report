...
const roadmapData = {
  header: {
    title: "实施路线总结：先试点验证，再决策扩展",
    subtitle: "围绕100万试点投入，按“上线—试用—评估—扩展”分阶段推进",
  },
  phases: [
    {
      step: "阶段 01",
      ...
      dataFocus: "阶段目标：统一投入",
      dataDesc: "完成100万试点预算执行，平台费40万与基础设施底座60万同步落地",
      tasks: ["统一试点中枢部署", "统一基础设施与监控", "明确试用容量与验收口径"],
    },
    {
      step: "阶段 02",
      name: "三场景上线",
      type: "foundation" as const,
      dataFocus: "阶段目标：跑通链路",
      dataDesc: "先上线问药、问数、问策三大核心场景，确保全链路可用",
      tasks: ["问药场景上线", "问数场景上线", "问策场景上线"],
    },
    {
      step: "阶段 03",
      name: "试用验证",
      type: "foundation" as const,
      dataFocus: "阶段目标：验证效果",
      dataDesc: "组织核心业务部门与领导约100人试用，稳定支撑约10并发",
      tasks: ["组织试用与培训", "跟踪高频问法表现", "按周复盘准确率"],
    },
    {
      step: "阶段 04",
      name: "知识库增强",
      type: "foundation" as const,
      dataFocus: "阶段目标：持续优化",
      dataDesc: "围绕低分问题持续补齐非结构化知识库，提升答案质量与稳定性",
      tasks: ["增补文档与经验案例", "更新标签与溯源链路", "发布迭代版本并复测"],
    },
    {
      step: "阶段 05",
      name: "扩展决策",
      ...
      dataFocus: "阶段目标：有序扩展",
      dataDesc: "以准确率、稳定性和试用反馈为扩展门槛，达标后再推进后续场景与规模建设",
      tasks: [
        "组织阶段评审并确认阈值",
        "明确下一阶段扩展范围与预算",
        "形成长期运营与治理机制",
      ],
      outcome: "形成“先验证、再扩展”的可持续推进机制，降低投入风险并提升落地质量",
    },
  ],
} as const;
